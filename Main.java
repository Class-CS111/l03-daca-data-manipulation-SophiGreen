  ...
  public static void main(String[] args) 
	{
		...
		/***** OUTPUT SECTION *****/
		System.out.println("Julian Day Number for today's date, " + monthToday + "/" + dayToday + "/" + yearToday + ", is " + jdnBday);
		System.out.println();
		System.out.println("Julian Day Number for birthday, " + monthBday + "/" +  dayBday + "/" + yearBday + ", is " + jdnBday);
		System.out.println();
		System.out.println("The differenve in days is " + diff + ", which makes you approximately " + approxAge + " years old!"); 
  }
}